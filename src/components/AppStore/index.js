...
class AppStore extends Component {
  ...
  render() {
    const {ActiveTabId, SerachInput} = this.state
    const filteredAppItems = this.getfilteredAppItems()
    const SearchFilteredAppItems = filteredAppItems.filter(eachItem =>
      eachItem.appName.toLowerCase().includes(SerachInput.toLowerCase()),
    )
    return (
      <div className="bg-container">
        ...
        <ul className="ul-apps">
          {SearchFilteredAppItems.map(eachApp => (
